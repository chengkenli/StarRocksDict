...
func init() {
	if util.MetaConf["slow_query_lark_app"] == nil || util.MetaConf["slow_query_lark_appid"] == nil || util.MetaConf["slow_query_lark_appsecret"] == nil || util.MetaConf["slow_query_proxy_feishu"] == nil {
		return
	}
	...
	larkdata := util.Read.Schema.LarkMeta
	if larkdata == "" {
		return
	}
